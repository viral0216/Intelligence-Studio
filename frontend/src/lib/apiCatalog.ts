    ...
    subcategories: [
      ...
      },
      {
        ...
        endpoints: [
          ...
          { label: "Create storage credential", method: "POST", path: "/api/2.0/accounts/ACCOUNT_ID/metastores/METASTORE_ID/storage-credentials", description: "Create a storage credential", body: { name: "my-credential", azure_service_principal: { directory_id: "TENANT_ID", application_id: "APP_ID", client_secret: "SECRET" } }, docs: { summary: "Create account storage credential", docUrl: "https://docs.databricks.com/api/azure/account/accountstoragecredentials/create" } },
